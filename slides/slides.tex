...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Для таких задач необходимо писать самому или искать примеры программ.
...
\begin{frame}
    ...
    Разработать генератор примеров программ для обучения в виде текста или изображения с поддержкой
    с возможностью генерации кода на разных языках программирования и управления задачами, на основе
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item Разработка предметно-ориентированного языка построения шаблонов программ, генерирующего
